...
# $packageRepo = 'http://choco.szpitalsm.local'
...
# UPDATE THIS PATH
$localChocolateyPackageFilePath = '\\10.0.0.12\_terminalRO\choco\chocolatey.1.1.0.nupkg'
...
$unzipMethod = 'builtin'
#$unzipMethod = '7zip'
#$7zipUrl = 'https://community.chocolatey.org/7za.exe' (download this file, host internally, and update this to internal)
...
# Remove choco default repo and add wsm
C:\ProgramData\chocolatey\choco.exe source remove -n=chocolatey | Out-Null
C:\ProgramData\chocolatey\choco.exe source add -n=wsm -s="'\\10.0.0.12\_terminalRO\choco'" | Out-Null


$dirpath = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\ChocolateyAgent"
